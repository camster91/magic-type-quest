...
The [world readiness record](evidence/165-world-readiness-2026-09-25.md) documents 25 new isolated scene/disposal/document-policy cases plus all 70 prior cases passing. Six real-Phaser browser journeys are now included in `validate:persistence` but remain unrun in the restricted recovery environment. They inspect required image decoding, five scene texture/listener/tween/timer cycles, deferred Game destruction, cancelled loads and modal focus. See the [local asset lifecycle addendum](architecture/LOCAL-ASSET-LIFECYCLE.md) for the narrowly scoped v2 Blob CSP and the shared startup adapter and its required whole-shell browser checks. No production-art or full browser acceptance is claimed.

## Whole-shell ownership continuation

The [whole-shell evidence](evidence/165-global-lifecycle-2026-09-25.md) records 23
new isolated visibility/startup checks and the earlier 95 checks passing. The
new browser journeys cover five full Game lifetimes and cancellation in native
preBoot; they are authored, not executed here. No budgets, runtime dependencies,
learner-data schema, curriculum or production routes change.
