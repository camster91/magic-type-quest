...
| Tests | ✅ 166 vitest tests pass across 15 files |
| Browser journeys | ✅ 7 Playwright tests cover responsive home actions, keyboard onboarding, the production build, PWA scope, offline reload, and cache cleanup |
