...
| Tests | ✅ 160 vitest tests pass across 14 files |
| Browser journeys | ✅ 6 Playwright tests cover keyboard onboarding, the production build, PWA scope, offline reload, and cache cleanup |
