export const dictionaries = {
  en: {
    ...
    'daily.complete': 'Daily Moment complete!', 'daily.questDone': 'Quest complete!', 'practice.type': 'Type: {word}',
  ...
  fr: {
    ...
    'game.useFinger': 'Utilise ton {finger}', 'game.levelComplete': 'Niveau terminé ! 🌟',
  ...
  es: {
    ...
    'game.useFinger': 'Usa tu {finger}', 'game.levelComplete': '¡Nivel completado! 🌟',
